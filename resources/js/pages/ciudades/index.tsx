...
const breadcrumbs: BreadcrumbItem[] = [{ title: 'Ciudades', href: '/ciudades' }];
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {ciudades.data.length === 0 ? (
                                <TableRow>
                                    <TableCell colSpan={2} className="text-muted-foreground py-8 text-center">No hay ciudades registradas.</TableCell>
                                </TableRow>
                            ) : (
                                    ...
                                    <TableRow key={ciudad.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex justify-end gap-1">
                                                {can('ciudades.editar') && (
                                                    <Button variant="ghost" size="icon" onClick={() => abrirEditar(ciudad)}>
                                                        <Pencil className="size-4" />
                                                    </Button>
                                                )}
                                                {can('ciudades.eliminar') && (
                                                    <Button variant="ghost" size="icon" onClick={() => eliminar(ciudad)}>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {editando ? 'Modifica los datos de la ciudad.' : 'Registra una ciudad para tu ISP.'}
                        </DialogDescription>
                    </DialogHeader>
